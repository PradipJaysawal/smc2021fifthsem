...
@section('content')
    <div class="grid grid-cols-4 gap-10 mt-5 px-24">
        <div class="border-r">
            ...
            <p class="text-2xl font-semibold">Rs. {{$package->price}}</p>
            <p class="text-gray-500">Capacity: {{$package->capacity}} Person</p>
        ...
        <div class="col-span-3">
            <form action="{{route('addtocart')}}" method="POST" class="grid grid-cols-3">
                ...
                <div class="col-span-2">
                    <h2 class="text-2xl font-semibold">Available</h2>
                    <div class="p-2 m-2">
                ...
                <div class="flex flex-col justify-center border-l">
                    ...
                    <div class="p-2 m-2">
                        ...
                        <label for="date" class="ml-2">Event Date</label>
