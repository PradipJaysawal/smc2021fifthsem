@extends('header')
@section('content')
    <h2 class="font-bold text-3xl text-center"><i class="ri-shopping-cart-fill"></i> My Carts</h2>
            ...
            @foreach ($carts as $cart)
                <tr>
                    ...
                    <td class="border px-4 py-2 grid gap-2 justify-center">
                        ...
                        <a href="{{route('cart.destroy',$cart->id)}}" onclick="return confirm ('Are you sure to delete ?')" class="bg-red-600 text-white px-4 py-2 rounded-lg">Remove</a>
                    </td>
                </tr>
            @endforeach
        </table>
