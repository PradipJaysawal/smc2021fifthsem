    ...
    <a href="{{route('category.create')}}" class="px-4 py-2 bg-blue-600 rounded text-white">Add Category</a>
     ...
     <table class="w-full">
        ...
        {{-- <tr >
            ...
            <td class="border py-2">Category 1</td>
            <td class="border py-2"> <a href="" class="px-2 py-1 bg-blue-600 rounded-lg text-white">Edit</a>
            <a href="" class="px-2 py-1 bg-red-600 rounded-lg text-white">Delete</a></td>
        </tr> --}}
        ...
        <tr class="text-center">
            ...
            <td class="border py-2">
                ...
                <a href="{{route('category.destory',$category->id)}}" class="px-2 py-1 bg-red-600 rounded-lg text-white" onclick="return confirm('Are you sure to Delete?')">Delete</a>
            </td>
        </tr>
