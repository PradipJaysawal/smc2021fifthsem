...
<div class="my-10 text-right">
    <a href="{{route('notice.create')}}" class="px-4 py-2 bg-blue-600 rounded text-white">Add Notices</a>
</div>
...
<table class="w-full text-center">
    ...
    <tr>
        ...
        <td class="border py-2">
            ...
            <a href="{{route('notice.destroy',$notice->id)}}" onclick="return confirm ('Are you sure to delete ?')" class="px-2 py-1 bg-red-600 rounded-lg text-white">Delte</a>
        </td>
    </tr>
    @endforeach
</table>
