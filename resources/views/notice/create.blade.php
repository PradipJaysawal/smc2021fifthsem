...
<form action="{{route('notice.store')}}" method="POST" class="mt-5">
    ...
    <input type="date" class="block w-full my-5 rounded-lg border-gray-300" placeholder="Notice Date" name="notice_date" value="{{old('notioce_date')}}">
    @error('notice_date')
    ...
    <div class="flex justify-center gap-3">
        ...
        <a href="{{route('notice.index')}}" class="bg-red-600 text-white px-3 py-2 rounded-lg">Exit</a>
    </div>
</form>
@endsection
